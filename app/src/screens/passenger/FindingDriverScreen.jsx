...
import { Bike, X, Radio, ShieldCheck } from 'lucide-react';
    ...
    <div className="absolute inset-0 z-30 bg-gray-950/90 backdrop-blur-md flex flex-col items-center justify-between p-6 pb-[calc(1.5rem+env(safe-area-inset-bottom,12px))]">
      ...
      <div className="pt-8 text-center">
        ...
        <p className="text-xs text-gray-400 mt-1">
          Searching nearby online bike drivers in 3.0 km radius... ({seconds}s)
        </p>
      </div>
      ...
      <div className="relative flex items-center justify-center my-auto">
        ...
        <div className="relative z-10 w-24 h-24 rounded-full bg-brand-yellow flex items-center justify-center text-gray-950 shadow-2xl shadow-brand-yellow/30">
          <Bike className="w-12 h-12 animate-bounce" />
        </div>
      </div>
