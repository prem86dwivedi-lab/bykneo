...
export const LiveTrackingScreen = ({ ride, onCancelRide }) => {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 z-20 px-3 pb-4 pb-[env(safe-area-inset-bottom,16px)] pointer-events-none">
      <div className="max-w-lg mx-auto bg-gray-900/95 backdrop-blur-xl border border-gray-800 rounded-3xl p-4 shadow-2xl pointer-events-auto space-y-3">
        {/* Status Header Pill */}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-semibold text-brand-yellow">
                {ride.vehicle_model || 'Bykneo Vehicle'} • <span className="text-white font-mono font-bold">{ride.vehicle_number || 'MP 04 AB 4589'}</span>
              </p>
        ...
        {/* Trip Summary Quick Card with "Trip Details & Fare" Button */}
        <div className="bg-gray-850/80 rounded-2xl p-3 border border-gray-800 space-y-2">
          {/* Quick Metrics Bar: Distance KM + Duration + Total Fare */}
          <div className="flex items-center justify-between pb-2 border-b border-gray-800 text-xs">
            ...
            <button
              ...
              className="text-[11px] font-black text-brand-yellow hover:underline flex items-center gap-1 bg-brand-yellow/10 border border-brand-yellow/30 px-2.5 py-1 rounded-lg active:scale-95 transition"
            >
              <FileText className="w-3 h-3" />
              <span>Trip Details & Fare</span>
      ...
      {/* Comprehensive Trip Details & Fare Breakdown Modal */}
      {showDetailsModal && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-end sm:items-center justify-center p-3 animate-in fade-in duration-200">
          <div className="bg-gray-900 border border-brand-yellow/30 rounded-3xl p-5 max-w-sm w-full space-y-4 shadow-2xl animate-in slide-in-from-bottom duration-200 text-left pointer-events-auto">
            ...
            {/* Distance & Duration Highlight Cards */}
            ...
            <div className="bg-gray-850 p-3 rounded-2xl border border-gray-800 space-y-2 text-xs">
              ...
              <div className="h-[1px] bg-gray-800 ml-4"></div>
              <div className="flex items-start gap-2">
